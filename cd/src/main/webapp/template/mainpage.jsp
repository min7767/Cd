        ...
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <nav>
                <ul class="flex space-x-4">
                    ...
                    <li><a href="${pageContext.request.contextPath}/template/signup.jsp" class="text-gray-700">회원가입</a></li>
                    <li><a href="${pageContext.request.contextPath}/template/login.jsp" class="bg-blue-500 text-white px-4 py-2 rounded">로그인</a></li>
                </ul>
            </nav>
        </div>
    </header>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-pink-100 p-4 rounded shadow-md">
                <a href="#" class="block text-center">
                    <img src="${pageContext.request.contextPath}/static/img/laptop.jpg" alt="노트북 대여" class="mx-auto mb-4">
                    <span class="text-lg font-semibold">노트북 대여</span>
                </a>
            </div>
            <div class="bg-pink-100 p-4 rounded shadow-md">
                <a href="#" class="block text-center">
                    <img src="${pageContext.request.contextPath}/static/img/tablet.jpg" alt="패드/탭 대여" class="mx-auto mb-4">
    ...
    <footer class="bg-gray-200 py-4 mt-8">
        <div class="container mx-auto px-4 text-center">
            <ul class="flex justify-center space-x-4">
                <li><a href="${pageContext.request.contextPath}/template/footers/terms.jsp" class="text-gray-700">이용약관</a></li>
                <li><a href="${pageContext.request.contextPath}/template/footers/trade_terms.jsp" class="text-gray-700">거래약관</a></li>
                <li><a href="${pageContext.request.contextPath}/template/footers/privacy.jsp" class="text-gray-700">개인정보 취급방침</a></li>
                <li><a href="${pageContext.request.contextPath}/template/footers/support.jsp" class="text-gray-700">1대1 문의</a></li>
            </ul>
        </div>
    </footer>
</body>
